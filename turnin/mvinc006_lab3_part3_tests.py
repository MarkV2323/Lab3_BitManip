...
tests = [ 
    ...
    'expected': [('PORTC',0x40)],
     ...
     # FL = 11, PA6-PA4 are all 1, PC4-PC0 are 1, PC hex is 0x1F
    {'description': 'PINA: 0x7B => PORTC: 0x1F',
    ...
    # FL = 7, PA6 is 0, PA5-PA4 are 1, PC3-PC0 are 1, PC6 is 1, hex is 0xCF
    {'description': 'PINA: 0x37 => PORTC: 0xCF',
